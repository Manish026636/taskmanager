      ...
      <div className='bg-[#eef2f5] w-full  lg:w-96  h-[77vh] rounded-xl'>
        <div className='grid grid-cols-2'>
          <div className='flex p-4 justify-start'>
            <h1 className="text-md mt-3 mb-3 font-bold text-gray-800">Done</h1>
          </div>
            ...
            <div class=" pt-4 px-4">
              <div className='grid grid-cols-2'>
                ...
                <div className='flex items-center justify-end gap-2'>
                  <button className='text-xs bg-[#22C8AA] py-2  font-semibold rounded-lg px-4 text-gray-50'>02-11-2023</button>                </div>
              </div>
            </div>                 
